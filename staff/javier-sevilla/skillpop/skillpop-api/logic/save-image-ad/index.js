...
// const { ObjectId, models: { User } } = require('skilpop-data')
// const fs = require('fs')
...
//     validate.string.notVoid('adId', filename)
//     if (!ObjectId.isValid(filename)) throw new ContentError(`${filename} is not a valid filname`)
