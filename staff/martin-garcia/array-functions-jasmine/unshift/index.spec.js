describe('unshift()', function() {
    it('should add the elements at the beggining of the array', function() {
        ...
        expect(unshift(initial, arrayToAdd)).toBe(expectedLength);
    ...
    it('Should throws an error if array is not an Array', function() {
        var array = 'pepito'
        var elements = [1, 2, 3];
        expect(function() { unshit(array, fn) }).toThrowError(TypeError, array + ' is not an Array');
    });

    it('Should throws an error if elements is not an Array', function() {
        var array = [1, 2, 3];
        var elements = 'pepito';
        expect(function() { unshit(array, fn) }).toThrowError(TypeError, elements + ' is not an Array');
    });
});