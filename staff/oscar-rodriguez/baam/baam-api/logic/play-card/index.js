    ...
    return (async () => {
        ...
        switch (effect) {
            ...
            case 'HEAL':
                ...
                break
            case 'BLOCK':
                if (game.players[currentPlayer].tempZone.duration) discards.push(tempZone.card)
        ...
        if (duration > 0) {
            game.players[currentPlayer].duration--
            if (!duration) {
                game.players[currentPlayer].discards.push(tempZone.card)
