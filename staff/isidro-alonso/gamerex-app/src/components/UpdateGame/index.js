...
// import {registerUser} from '../../logic' //crear logica de update game
...
export default withRouter(function ({ history }) {
    ...
    const [password, setPassword] = useState('')
        ...
        const handleUpdateGame = async (e) => {
                e.preventDefault()
                try {
                        // await registerUser(username, location, email, password) //crear logica de update game
        ...
        return <section className="game-newedit">
            <form onSubmit={handleUpdateGame}>
                ...
                <button className="game-newedit__addimg">Update game cover</button>
                <button className="game-newedit__submit">Update</button>
            </form>
        </section>
})