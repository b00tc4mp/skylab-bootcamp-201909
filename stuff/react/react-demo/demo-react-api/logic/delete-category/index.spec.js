...
const deleteCategory = require('.')

describe('logic - delete category' , ()=>{
    ...
    it('should fail on empty category id', () => 
        expect(() => deleteCategory("")).to.throw('category id is empty or blank')
    )
    
    it('should fail on wrong category id type', () => 
        expect(() => deleteCategory(123)).to.throw('category id with value 123 is not a string')
    )
